...
def main():
    ...
    # 画像ファイルのパスを設定
    image_path = "/home/testos/Pictures/image/secom_ai_AMD_finish.gif"
    ...
    # テキストラベル
    label = tk.Label(root, text="セコムAIサーバAMDのテストがすべて完了しました", font=('Helvetica', 19, 'bold'), fg="blue", bg="white")
